...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c180 = "internal",
      peg$c181 = peg$literalExpectation("internal", false),
      peg$c182 = "library",
      peg$c183 = peg$literalExpectation("library", false),
      peg$c184 = "mapping",
      peg$c185 = peg$literalExpectation("mapping", false),
      peg$c186 = "memory",
      peg$c187 = peg$literalExpectation("memory", false),
      peg$c188 = "minutes",
      peg$c189 = peg$literalExpectation("minutes", false),
      peg$c190 = "modifier",
      peg$c191 = peg$literalExpectation("modifier", false),
      peg$c192 = "new",
      peg$c193 = peg$literalExpectation("new", false),
      peg$c194 = "null",
      peg$c195 = peg$literalExpectation("null", false),
      peg$c196 = "private",
      peg$c197 = peg$literalExpectation("private", false),
      peg$c198 = "pragma",
      peg$c199 = peg$literalExpectation("pragma", false),
      peg$c200 = "public",
      peg$c201 = peg$literalExpectation("public", false),
      peg$c202 = "return",
      peg$c203 = peg$literalExpectation("return", false),
      peg$c204 = "returns",
      peg$c205 = peg$literalExpectation("returns", false),
      peg$c206 = "seconds",
      peg$c207 = peg$literalExpectation("seconds", false),
      peg$c208 = "set",
      peg$c209 = peg$literalExpectation("set", false),
      peg$c210 = "solidity",
      peg$c211 = peg$literalExpectation("solidity", false),
      peg$c212 = "storage",
      peg$c213 = peg$literalExpectation("storage", false),
      peg$c214 = "struct",
      peg$c215 = peg$literalExpectation("struct", false),
      peg$c216 = "super",
      peg$c217 = peg$literalExpectation("super", false),
      peg$c218 = "szabo",
      peg$c219 = peg$literalExpectation("szabo", false),
      peg$c220 = "this",
      ...
      peg$c226 = "using",
      peg$c227 = peg$literalExpectation("using", false),
      peg$c228 = "var",
      peg$c229 = peg$literalExpectation("var", false),
      peg$c230 = "weeks",
      peg$c231 = peg$literalExpectation("weeks", false),
      peg$c232 = "wei",
      peg$c233 = peg$literalExpectation("wei", false),
      peg$c234 = "while",
      peg$c235 = peg$literalExpectation("while", false),
      peg$c236 = "years",
      peg$c237 = peg$literalExpectation("years", false),
      peg$c238 = ";",
      peg$c239 = peg$literalExpectation(";", false),
      peg$c240 = function() { return { type: "ThisExpression", start: location().start.offset, end: location().end.offset }; },
      peg$c241 = "(",
      ...
      peg$c254 = function(elements, elision) {
            return {
              type:     "ArrayExpression",
      ...
      peg$c255 = function(elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c256 = function(head, elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c257 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
      peg$c258 = function(commas) { return filledArray(commas.length + 1, null); },
      peg$c259 = function(callee, args) {
                return { type: "NewExpression", callee: callee, arguments: args, start: location().start.offset, end: location().end.offset };
              },
      peg$c260 = function(head, property) {
                return { property: property, computed: true, start: location().start.offset, end: location().end.offset };
              },
      peg$c261 = function(head, property) {
      ...
      peg$c267 = function(head, property) {
                return {
                  type:     "MemberExpression",
                  property: property,
                  computed: false,
      ...
      peg$c269 = function(args) {
            return optionalList(extractOptional(args, 0));
          },
      peg$c270 = function(head, tail) {
            return buildList(head, tail, 3);
          },
      peg$c271 = function(literal, members, parts) {
          return {
            type: "Type",
      ...
      peg$c276 = function(expression) {
          return expression;
        },
      peg$c277 = function(type, specifiers, id, value) {
          return {
      ...
      peg$c278 = function(type, storage, id) {
          return {
      ...
      peg$c296 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c297 = "*",
      ...
      peg$c345 = function(left, operator, right) {
            return {
              type:     "AssignmentExpression",
              operator: operator,
              left:     left,
      ...
      peg$c376 = function(head, tail, init) {
            return {
              declarations: buildList(head, tail, 3),
              init: extractOptional(init, 1)
            }
          },
      peg$c377 = function(id) {
            return {
      ...
      peg$c379 = function() { return { type: "EmptyStatement", start: location().start.offset, end: location().end.offset }; },
      peg$c380 = function(expression) {
            return {
      ...
      peg$c381 = function(test, consequent, alternate) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c382 = function(test, consequent) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c383 = function(start_version, end_version) {
          return {
      ...
      peg$c386 = function(symbols, from) {
          return {
            type: "ImportStatement",
            from: from.value,
            symbols: symbols,
      ...
      peg$c387 = function(library, type) {
          return {
            type: "UsingStatement",
      ...
      peg$c390 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test, start: location().start.offset, end: location().end.offset }; },
      peg$c391 = function(test, body) { return { type: "WhileStatement", test: test, body: body, start: location().start.offset, end: location().end.offset }; },
      peg$c392 = function(init, test, update, body) {
            return {
              type:   "ForStatement",
      ...
      peg$c393 = function(declarations, test, update, body) {
            return {
              type:   "ForStatement",
              init:   {
                type:         "VariableDeclaration",
      ...
      peg$c394 = "assembly",
      peg$c395 = peg$literalExpectation("assembly", false),
      ...
      peg$c408 = function(fnname, isanonymous) {
          return {
      ...
      peg$c409 = function(fnname, names, body) {
            return {
      ...
      peg$c410 = function(fnname, args, body) {
            return {
      ...
      peg$c415 = function(type, isindexed, isconstant, isstorage, ismemory, id) {
          return {
      ...
      peg$c417 = function(id, head, tail) {
          return {
      ...
      peg$c422 = "let",
      peg$c423 = peg$literalExpectation("let", false),
      peg$c424 = ":=",
      peg$c425 = peg$literalExpectation(":=", false),
      peg$c426 = function(name, expression) {
          return {
      ...
      peg$c427 = function(name, expression) {
          return {
      ...
      peg$c431 = function(name, head, tail) {
          return {
                  ...
                  if (s8 !== peg$FAILED) {
                    ...
                    if (s9 !== peg$FAILED) {
                      ...
                      if (s10 !== peg$FAILED) {
                        ...
                        if (s11 !== peg$FAILED) {
                          peg$savedPos = s0;
                          s1 = peg$c415(s1, s3, s5, s7, s9, s11);
                          s0 = s1;
                        } else {
                          peg$currPos = s0;
                          s0 = peg$FAILED;
