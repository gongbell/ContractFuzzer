/*
 * Solidity Import parser. For parsing imports and nothing else.
 */
...
ContractStatement
  = ContractToken __ id:Identifier __ is:IsStatement? __ BlockList
  {
    return undefined
  }
...
ModifierName
  = id:Identifier __ params:("(" (!(")") SourceCharacter)* ")")?
  {
    return null
  }
